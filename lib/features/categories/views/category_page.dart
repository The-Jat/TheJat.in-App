...
import '../providers/sub_categories_controller.dart';
import '../../posts/providers/categories_post_controller.dart';
import '../../posts/providers/post_pagination_class.dart';
import '../data/models/category.dart';
import '../../../core/utils/app_utils.dart';
import '../../home/views/components/loading_posts_responsive.dart';
import '../../explore/views/components/empty_categories.dart';
              ...
              slivers: [
                SliverAppBar(
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    title: AutoSizeText(
                      AppUtils.trimHtml(arguments.category.name),
        ...
        children: [
          ...
          if (paginationController.isPaginationLoading)
            const SliverToBoxAdapter(
              child: Padding(padding: EdgeInsets.all(16.0), child: AppLoader()),
            ),
        ],
      );
    }
