...
class OnboardingRepository {
  ...
  final _preferenceDialogKey = 'isPreferenceDialogShown';

  bool isPreferenceDialogShown() {
    var box = Hive.box(_boxKey);
    return box.get(_preferenceDialogKey) ?? false;
  }

  void savePreferenceDialogShown() {
    var box = Hive.box(_boxKey);
    box.put(_preferenceDialogKey, true);
  }
}
